...
<div class="page-container">
                  ...
                  <div class="row">
                    <div class="col-xs-6">
                      <div class="swin-sc swin-sc-title text-left">
                        <h3 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="500" class="title animated fadeInUp">Deliciousness jumping into the mouth</h3>
                        <h4 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1000" class="subtitle animated fadeInUp">Let Enjoy The Rhym Of Fooday Dishes</h4>
                      </div>
                      <div data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1200" class="btn-wrap text-left animated fadeInUp"><a href="javascript:void(0)" class="btn swin-btn btn-transparent"> <span>Read More</span></a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="slide-content slide-layout-01">
                <div class="container">
                  <div class="row">
                    <div class="col-xs-6">
                      <div class="swin-sc swin-sc-title text-left">
                        <h3 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="500" class="title animated fadeInUp">Where food speaks with your palate</h3>
                        <h4 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1000" class="subtitle animated fadeInUp">We speak the good food language</h4>
                      </div>
                      <div data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1200" class="btn-wrap text-left animated fadeInUp"><a href="javascript:void(0)" class="btn swin-btn btn-transparent"> <span>Read More</span></a></div>
                    </div>
                  </div>
          ...
          <div class="page-content-wrapper">
            <div class="page-content no-padding">
                    ...
                    <div class="row">
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item icon-box-02">
                          <div class="wrapper-icon"><i class="icons fa fa-shopping-bag"></i><span class="number">1</span></div>
                          <h4 class="title">Online Order</h4>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item icon-box-02">
                          <div class="wrapper-icon"><i class="icons fa fa-truck"></i><span class="number">2</span></div>
                          <h4 class="title">Fast Delivery</h4>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item icon-box-02">
                          <div class="wrapper-icon"><i class="icons fa fa-gift"></i><span class="number">3</span></div>
                          <h4 class="title">Special Gift</h4>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item icon-box-02">
                          <div class="wrapper-icon"><i class="icons fa fa-users"></i><span class="number">4</span></div>
                          <h4 class="title">Friendly Support</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="blog-item item swin-transition">
                            ...
                            <div class="block-content">
                              <h5 class="title"><a href="javascript:void(0)">Mexico Beafsteak</a></h5>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="blog-item item swin-transition">
                            ...
                            <div class="block-content">
                              <h5 class="title"><a href="javascript:void(0)">Madagasca Lopster</a></h5>
                              <div class="product-info">
                                <ul class="list-inline">
                                  <li class="author"><span>Chef</span><span class="text">Don Joe</span></li>
                                  <li class="rating"><a href="javascript:void(0)"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></a></li>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="blog-item item swin-transition">
                            ...
                            <div class="block-content">
                              <h5 class="title"><a href="javascript:void(0)">Jambon Salad</a></h5>
                              <div class="product-info">
                                <ul class="list-inline">
                                  <li class="author"><span>Chef</span><span class="text">Don Joe</span></li>
                                  <li class="rating"><a href="javascript:void(0)"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></a></li>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="blog-item item swin-transition">
                            ...
                            <div class="block-content">
                              <h5 class="title"><a href="javascript:void(0)">Mexico Potato</a></h5>
                              <div class="product-info">
                                <ul class="list-inline">
                                  <li class="author"><span>Chef</span><span class="text">Don Joe</span></li>
                                  <li class="rating"><a href="javascript:void(0)"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></a></li>
              ...
              <section>
                <div class="container">
                  <div class="shop-banner banner-section">
                    <div class="row">
                      <div class="col-md-8 col-md-offset-2">
                        <div class="content-wrapper">
                          <h2 class="heading-title">BIGGEST EVENT - SALE<span class="text-large">50% OFF</span>IN THIS WEEK</h2>
                          <p class="des">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt</p>
                        </div>
                        <div class="swin-btn-wrap center mtxxl"><a href="#" class="swin-btn center btn-transparent btn-white"> <span>READ MORE</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
