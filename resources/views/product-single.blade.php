                      ...
                      <div class="container">
                          <div class="title-wrapper">
                              <div data-top="transform: translateY(0px);opacity:1;"
                                  ...
                                  data-anchor-target=".page-title" class="title">Product Single</div>
                              ...
                              <div data-top="transform: translateY(0px);opacity:1;"
                                  ...
                                  data--50-top="transform: translateY(15px);opacity:0.8;"
                                  data--120-top="transform: translateY(30px);opacity:0;"
                                  data-anchor-target=".page-title" class="subtitle">We hope you will like this product
                                  and give us 5 star rating</div>
                          </div>
                      </div>
                  </div>
                                      ...
                                      <div class="product-image">
                                          <div class="product-featured-image">
                                              <div class="main-slider">
                                                  <div class="slides">
                                                      <div class="featured-image-item"><img
                                                              src="assets/images/product/product-full-02.jpg"
                                                              alt="fooday" class="img img-responsive"></div>
                                                      <div class="featured-image-item"><img
                                                              src="assets/images/product/product-full-03.jpg"
                                                              alt="fooday" class="img img-responsive"></div>
                                                      <div class="featured-image-item"><img
                                                              src="assets/images/product/product-full-04.jpg"
                                                              alt="fooday" class="img img-responsive"></div>
                                                      <div class="featured-image-item"><img
                                                              src="assets/images/product/product-full-02.jpg"
                                                              alt="fooday" class="img img-responsive"></div>
                                              ...
                                              <div data-width="150" class="nav-slider">
                                                  <ul class="slides list-inline">
                                                      <li class="swin-transition thumbnail-image-item"><a
                                                              href="javascript:void(0)"
                                                              class="testimonial-nav-item"><img
                                                                  src="assets/images/product/product-thumb-02.jpg"
                                                                  alt="fooday"
                                                                  class="img img-responsive swin-transition"></a></li>
                                                      <li class="swin-transition thumbnail-image-item"><a
                                                              href="javascript:void(0)"
                                                              class="testimonial-nav-item"><img
                                                                  src="assets/images/product/product-thumb-03.jpg"
                                                                  alt="fooday"
                                                                  class="img img-responsive swin-transition"></a></li>
                                                      <li class="swin-transition thumbnail-image-item"><a
                                                              href="javascript:void(0)"
                                                              class="testimonial-nav-item"><img
                                                                  src="assets/images/product/product-thumb-04.jpg"
                                                                  alt="fooday"
                                                                  class="img img-responsive swin-transition"></a></li>
                                                      <li class="swin-transition thumbnail-image-item"><a
                                                              href="javascript:void(0)"
                                      ...
                                      <div class="product-summary">
                                          ...
                                          <div class="product-info">
                                              <ul class="list-inline">
                                                  <li class="author"><span>Chef</span><span class="text">Don Joe</span>
                                                  </li>
                                                  <li class="rating"><a href="javascript:void(0)"><i
                                                              class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                              class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                              class="fa fa-star-o"></i></a><span>4 Reviews</span></li>
                                              </ul>
                                          </div>
                                          <div class="product-desc">
                                              <p>Turnip greens yarrow ricebean rutabaga endive cauliflower sea lettuce
                                          ...
                                          <div class="product-meta-info">
                                              <div class="meta-info-item">
                                                  ...
                                                  <div class="meta-info-text"><a
                                                          href="javascript:void(0)">Breakfast</a>,<a
                                                          href="javascript:void(0)">Seafood</a>,<a
                                                          href="javascript:void(0)">Main Menu</a></div>
                                              </div>
                                              <div class="meta-info-item">
                                                  <div class="meta-info-caption">Tags:</div>
                                                  <div class="meta-info-text"><a href="javascript:void(0)">Shrimp</a>,<a
                                                          href="javascript:void(0)">Vegetables</a></div>
                                              </div>
                                          </div>
                                              ...
                                              <form action="#">
                                                  <div class="input-group">
                                                      <input type="text" name="quanlity" placeholder="" value="1"
                                                          class="form-control"><a href="javascript:void(0)"
                                                          class="quanlity-plus"><i class="fa fa-plus"></i></a><a
                                                          href="javascript:void(0)" class="quanlity-minus"><i
                                                              class="fa fa-minus"></i></a>
                                                  </div>
                                                  <div class="add-to-cart"><a href="javascript:void(0)"
                                                          class="swin-btn"> <span>Add To Cart</span></a></div>
                                              </form>
                                          </div>
                                  ...
                                  <div class="col-md-12">
                                      <div class="product-tab-content">
                                          ...
                                          <ul role="tablist" class="nav nav-tabs">
                                              <li role="presentation" class="active"><a href="#product-desc-tab"
                                                      aria-controls="product-desc-tab" role="tab"
                                                      data-toggle="tab">DESCRIPTIONS</a></li>
                                              <li role="presentation"><a href="#product-review"
                                          ...
                                          <div class="tab-content">
                                              <div id="product-desc-tab" role="tabpanel" class="tab-pane active">
                                                  ...
                                                  <p>Turnip greens yarrow ricebean rutabaga endive cauliflower sea
                                                      ...
                                                      cabbage asparagus winter purslane kale. Celery potato scallion
                                                      desert raisin horseradish spinach carrot soko. Lotus root water
                                                      spinach fennel kombu maize bamboo shoot green bean.</p>
                                              </div>
                                                  ...
                                                  <div id="reviews">
                                                      <div id="comments">
                                                          ...
                                                          <ul class="commentlist list-unstyled">
                                                              <li>
                                                                  <div class="comment_container"><img
                                                                      ...
                                                                      <div class="comment-text">
                                                                          ...
                                                                          <p class="meta"><strong
                                                                                  itemprop="author">Maria</strong> –
                                                                              <time itemprop="datePublished"
                                                                                  datetime="2013-06-07T15:56:24+00:00">June
                                                                                  7, 2017</time>:
                                                                          </p>
                                                              ...
                                                              <li>
                                                                  <div class="comment_container"><img
                                                                          src="assets/images/blog/blog-comment-avatar03.jpg"
                                                                          width="60" height="60" alt=""
                                                                          class="avatar avatar-60wp-user-avatar wp-user-avatar-60 alignnone photo avatar-default">
                                                                      <div class="comment-text">
                                                                          <div class="star-rating"><i
                              ...
                              <div class="swin-sc swin-sc-product products-02 carousel-01 woocommerce">
                                  <div class="products nav-slider">
                                      <div class="blog-item item swin-transition">
                                          <div class="block-img"><img src="{{asset('assets/images/product/product-2a.jpg')}}" alt=""
                                                  class="img img-responsive">
                                              <div class="block-circle price-wrapper"><span
                                                      class="price woocommerce-Price-amount amount"><span
                                                          class="price-symbol">$</span>25.0</span></div>
                                              <div class="group-btn"><a href="javascript:void(0)"
                                                      class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a
                                                      href="javascript:void(0)" class="swin-btn btn-add-to-card"><i
                                                          class="fa fa-shopping-basket"></i></a></div>
                                          </div>
                                          <div class="block-content">
                                              <h5 class="title"><a href="javascript:void(0)">Mexico Beafsteak Potato
                                                      fly</a></h5>
                                              <div class="info">
                                                  <div class="author">Chef <span class="name">Don Joe</span></div>
                                                  <div class="star-rating"><span style="width:80%"
                                                          class="rating"><strong class="rating"></strong></span></div>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="blog-item item swin-transition">
                                          <div class="block-img"><img src="{{asset('assets/images/product/product-2b.jpg')}}" alt=""
                                                  class="img img-responsive">
                                              <div class="block-circle price-wrapper"><span
                                                      class="price woocommerce-Price-amount amount"><span
                                          ...
                                          <div class="block-content">
                                              <h5 class="title"><a href="javascript:void(0)">Mexico Beafsteak Potato</a>
                                              </h5>
                                              <div class="info">
                                                  <div class="author">Chef <span class="name">Don Joe</span></div>
                                                  <div class="star-rating"><span style="width:80%"
                                      ...
                                      <div class="blog-item item swin-transition">
                                          <div class="block-img"><img src="{{asset('assets/images/product/product-2c.jpg')}}" alt=""
                                                  class="img img-responsive">
                                              <div class="block-circle price-wrapper"><span
                                                      class="price woocommerce-Price-amount amount"><span
                                          ...
                                          <div class="block-content">
                                              <h5 class="title"><a href="javascript:void(0)">Madagasca Lopster Tasty</a>
                                              </h5>
                                              <div class="info">
                                                  <div class="author">Chef <span class="name">Don Joe</span></div>
                                                  <div class="star-rating"><span style="width:80%"
                                      ...
                                      <div class="blog-item item swin-transition">
                                          <div class="block-img"><img src="{{asset('assets/images/product/product-2e.jpg')}}" alt=""
                                                  class="img img-responsive">
                                              <div class="block-circle price-wrapper"><span
                                                      class="price woocommerce-Price-amount amount"><span
                                          ...
                                          <div class="block-content">
                                              <h5 class="title"><a href="javascript:void(0)">Jambon Salad Hot Bread</a>
                                              </h5>
                                              <div class="info">
                                                  <div class="author">Chef <span class="name">Don Joe</span></div>
                                                  <div class="star-rating"><span style="width:80%"
                                      ...
                                      <div class="blog-item item swin-transition">
                                          <div class="block-img"><img src="{{asset('assets/images/product/product-2f.jpg')}}" alt=""
                                                  class="img img-responsive">
                                              <div class="block-circle price-wrapper"><span
                                                      class="price woocommerce-Price-amount amount"><span
